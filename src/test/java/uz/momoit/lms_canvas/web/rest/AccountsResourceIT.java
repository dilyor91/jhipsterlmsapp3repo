...
import uz.momoit.lms_canvas.domain.enumeration.UserStatus;
import uz.momoit.lms_canvas.domain.enumeration.UserType;
...
class AccountsResourceIT {
    ...
    void partialUpdateAccountsWithPatch() throws Exception {
        ...
        partialUpdatedAccounts.username(UPDATED_USERNAME).userType(UPDATED_USER_TYPE).userStatus(UPDATED_USER_STATUS);
