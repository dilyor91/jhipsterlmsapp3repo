...
import { sampleWithRequiredData } from '../wiki-page.test-samples';
import { WikiPageService } from '../service/wiki-page.service';

import { WikiPageComponent } from './wiki-page.component';
import SpyInstance = jest.SpyInstance;

describe('WikiPage Management Component', () => {
  let comp: WikiPageComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, WikiPageComponent],
      providers: [
        {
      ...
      .overrideTemplate(WikiPageComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.wikiPages?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
