...
import { sampleWithRequiredData } from '../question-group.test-samples';
...
describe('QuestionGroup Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, QuestionGroupComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.questionGroups?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
