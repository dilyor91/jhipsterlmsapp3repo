...
describe('QuestionGroup Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, QuestionGroupUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Course query and add missing value', () => {
      ...
      const course: ICourse = { id: 11613 };
      questionGroup.course = course;

      const courseCollection: ICourse[] = [{ id: 10744 }];
