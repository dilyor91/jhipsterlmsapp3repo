...
import { sampleWithRequiredData } from '../student-question.test-samples';
...
describe('StudentQuestion Management Component', () => {
  let comp: StudentQuestionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, StudentQuestionComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.studentQuestions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to studentQuestionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStudentQuestionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStudentQuestionIdentifier).toHaveBeenCalledWith(entity);
