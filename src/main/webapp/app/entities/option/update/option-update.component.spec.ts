...
describe('Option Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, OptionUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Question query and add missing value', () => {
      ...
      const question: IQuestion = { id: 25042 };
      option.question = question;

      const questionCollection: IQuestion[] = [{ id: 17684 }];
    ...
    it('Should update editForm', () => {
      const option: IOption = { id: 456 };
      const question: IQuestion = { id: 28177 };
      option.question = question;
