...
import { sampleWithRequiredData } from '../student-option.test-samples';
...
describe('StudentOption Management Component', () => {
  let comp: StudentOptionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, StudentOptionComponent],
      providers: [
        {
      ...
      .overrideTemplate(StudentOptionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.studentOptions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
