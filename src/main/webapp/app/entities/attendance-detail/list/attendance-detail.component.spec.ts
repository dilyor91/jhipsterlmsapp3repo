...
import { sampleWithRequiredData } from '../attendance-detail.test-samples';
...
describe('AttendanceDetail Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, AttendanceDetailComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.attendanceDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to attendanceDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAttendanceDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAttendanceDetailIdentifier).toHaveBeenCalledWith(entity);
